...
from ..datamodel.base_models import Cell, Size

if TYPE_CHECKING:
    from public_tech_lib.file_processing_service.third_party_lib.docling.datamodel.document import InputDocument
