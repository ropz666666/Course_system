...
from public_tech_lib.file_processing_service.third_party_lib.docling.DoclingServer import DoclingServer,ImageExtractor,TableExtractor,Chunker
import yaml
# def parse_args():
...
chunker_config_path = "public_tech_lib/file_processing_service/third_party_lib/docling/config/chunker_config.yaml"
convert_config_path = "public_tech_lib/file_processing_service/third_party_lib/docling/config/converter_config.yaml"
