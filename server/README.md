mysql -u root -p virtual_teacher < /path/to/backup/my_database.sql

mysqldump -u root -p virtual_teacher > D:\workplace\virtualTeacher\backend\sql\virtual_teacher.sql
...
`uvicorn main:app --host 0.0.0.0 --port 8020 --reload --ssl-keyfile privkey.key --ssl-certfile fullchain.pem`
